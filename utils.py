    ...
    for enc_name in enc_names:
        ...
        if encoder_type == 'mocov3':
            ...
            if 'reg' in encoder_type:
                path = "/home/user/code/zty/cvpr26/public/dinov2_vitb14_reg4_pretrain.pth"
            ...
            ckpt =  torch.load(f'/home/user/code/zty/iccv_research/REPA-main/ckpts/dinov1-vit-b.pth') 
