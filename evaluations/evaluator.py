...
def main():
    ...
    parser.add_argument("--ref_batch", help="path to reference batch npz file",default='/home/user/code/zty/cvpr24_precode/datasets/cifar10_train.npz')
    parser.add_argument("--sample_batch", help="path to sample batch npz file",default='/home/user/code/zty/cvpr24_precode/P2-weighting/cifar_sample2/samples_50000x32x32x3.npz')
